...
public class PownTest {
    @Test
    public void getPossibleMovesForPownPieceOnOtherPiece(){
        // Create a mock board
        ...
        Square pieceSquare2 = boardArray[2][4];
        pieceSquare2.setPieceOccupied(new Pown(0, pieceSquare2));
        Square pieceSquare3 = boardArray[2][2];
    ...
    @Test
    public void getPossibleMovesForPownPiece(){
        // Create a mock board
        Square[][] boardArray = new Square[8][8];
        //linking squares to board
        for (int i = 0; i < 8; i++) {
    ...
    @Test
    public void shouldPownCantMove(){
        // Create a mock board
        Square[][] boardArray = new Square[8][8];
        //linking squares to board
        for (int i = 0; i < 8; i++) {
